...
from llmcompressor.modifiers.awq_h.mappings import (
    AWQMapping,
    ResolvedMapping,
...
__all__ = ["AWQHModifier"]


class AWQHModifier(Modifier, QuantizationMixin):
    """
    Custom AWQ Modifier (awq_h) - Based on Activation-Weighted Quantization algorithm.
